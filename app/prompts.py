...
所有面向用户的标题使用基础 Markdown：一级写作“## 一、标题”，二级写作“### 1、标题”；继续细分时使用“1.1、”“1.1.1、”。不要使用表格嵌套、HTML 或代码围栏。
...
使用基础 Markdown：一级标题写作“## 一、标题”，二级标题写作“### 1、标题”；继续细分时使用“1.1、”“1.1.1、”。不要使用 HTML 或代码围栏：
一、访谈说明
1、研究问题与访谈对象
2、预计时长与知情同意
二、访谈问题
...
审查结论使用基础 Markdown：一级标题写作“## 一、标题”，二级标题写作“### 1、标题”；表格保持为普通 Markdown 表格，不要使用 HTML 或代码围栏。
...
7、审查表后按“一、可直接执行的提纲；1、知情同意；2、访谈问题；二、时间安排；三、注意事项”的层级输出最终结果。"""
...
使用基础 Markdown：一级标题写作“## 一、标题”，二级标题写作“### 1、标题”；继续细分时使用“1.1、”“1.1.1、”。不要使用 HTML 或代码围栏（“Mermaid主题图源码”例外，其源码本身可置于 `mermaid` 代码围栏）。
...
使用基础 Markdown：一级标题写作“## 一、标题”，二级标题写作“### 1、标题”；继续细分时使用“1.1、”“1.1.1、”。审计表使用普通 Markdown 表格，不要使用 HTML 或代码围栏。
