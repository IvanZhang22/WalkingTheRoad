...
3、音频：清小搭上传后进入后台任务，服务器将音频归一化为 16kHz 单声道、约 5 分钟分段，并通过 StepFun SSE 转写。首段抽样核对后，材料分析会先尝试运行 30 秒；仍未完成时转为后台任务，并给出基于材料体量的 ±20% 剩余时间估计。用户可发送“查看进度”“查看首段转写”“查看分析进度”“继续处理”“重新开始分析”“取消任务”。原始音频默认保留 24 小时，任务文本和状态保留 30 天。
